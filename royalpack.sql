...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 08 Gru 2020, 16:53
...
CREATE TABLE IF NOT EXISTS `im_object` (
  ...
  KEY `type_id` (`type_id`),
  KEY `label_id` (`label_id`)
) ENGINE=InnoDB AUTO_INCREMENT=135 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `section_id` (`section_id`),
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2306 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=483 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
