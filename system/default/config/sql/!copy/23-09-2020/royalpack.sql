...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 23 Wrz 2020, 11:30
...
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `section_id` (`section_id`),
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2192 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
