...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 09 Wrz 2020, 13:19
...
(89, 14, 14, 0, '', 'Sekcja oferta', '<i class=\"fal fa-grip-lines\"></i> Oferta <i class=\"fal fa-grip-lines\"></i>', NULL, '', '', '', '', '', '', '', 5, 'on', 'off', '', '2020-09-09', '2020-09-09 09:34:58', '2020-09-09 09:35:16'),
...
(94, 24, 6, 11, '<span>Więcej</span><i class=\"fal fa-arrow-to-right\"></i>', 'SRP Displays', 'SRP DISPLAYS', NULL, '', '', '', '', '', 'fal fa-boxes-alt', '', 11, 'on', 'off', '', '2020-09-09', '2020-09-09 09:54:19', '2020-09-09 10:44:40'),
...
(97, 24, 6, 13, '<span>Więcej</span><i class=\"fal fa-arrow-to-right\"></i>', 'E-commerce boxes', 'E-COMMERCE BOXES', NULL, '', '', '', '', '', 'fal fa-inbox', '', 13, 'on', 'off', '', '2020-09-09', '2020-09-09 10:13:25', '2020-09-09 10:44:40'),
...
(100, 24, 6, 23, '<span>Więcej</span><i class=\"fal fa-arrow-to-right\"></i>', 'Offset', 'OFFSET', NULL, '', '', '', '', '', 'fal fa-fill-drip', '', 17, 'on', 'off', '', '2020-09-09', '2020-09-09 10:24:34', '2020-09-09 10:44:40'),
(101, 24, 6, 24, '<span>Więcej</span><i class=\"fal fa-arrow-to-right\"></i>', 'Flexo', 'FLEXO', NULL, '', '', '', '', '', 'fal fa-fill', '', 18, 'on', 'off', '', '2020-09-09', '2020-09-09 10:31:36', '2020-09-09 10:44:40'),
...
(106, 14, 14, 0, '', 'Sekcja opakowania', '<i class=\"fal fa-grip-lines\"></i> Opakowania <i class=\"fal fa-grip-lines\"></i>', NULL, '', '', '', '', '', '', '', 5, 'on', 'off', '', '2020-09-09', '2020-09-09 13:13:24', '2020-09-09 13:13:43'),
(107, 10, 6, 0, '', 'Obsługa klienta', '<i class=\"fal fa-grip-lines\"></i> Obsługa klienta <i class=\"fal fa-grip-lines\"></i>', '<p>Oferujemy kompleksową obsługę w zakresie:</p>\r\n<ul>\r\n<li>projektowania druku,</li>\r\n<li>nadruku techniką offsetową i fleksograficzną,</li>\r\n<li>kaszerowania,</li>\r\n<li>wycinania,</li>\r\n<li>klejenia,</li>\r\n<li>magazynowania oraz dostawy.</li>\r\n</ul>\r\n<p>W naszej ofercie znajdziecie Państwo r&oacute;wnież opakowania bez nadruku i drukowane metodą flexograficzną. Bogate doświadczenie pozwala nam tworzyć rozwiązania indywidualne dopasowane do wymagań naszych klient&oacute;w. Zawsze służymy pomocą we wszelkich kwestiach dotyczących opakowań. Gwarantujemy punktualne dostawy finalnego produktu w wysokiej jakości. By ułatwić prowadzenie Państwa biznesu oferujemy r&oacute;wnież dostawy JUST IN TIME. Dysponujemy własnym transportem ciężarowym co umożliwia dostarczanie finalnego produktu zawsze na czas do Państwa firmy. Tak profesjonalnie, kompleksowo i elastycznie prowadzona obsługa pozwala na budowanie trwałych relacji z naszymi klientami.</p>', '', '', '', '', '', 'fal fa-grip-lines fa-3x', '', 1, 'on', 'off', '', '2020-09-09', '2020-09-09 13:21:08', '2020-09-09 15:11:46'),
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `section_id` (`section_id`),
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2037 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(189, 3, 'Obsługa klienta', 'im_object', 'content', 107, '<p>Jedes Unternehmen hat unterschiedliche Bed&uuml;rfnisse, weshalb bei Royalpack jeder Kunde individuell behandelt wird. Eine bestimmte Person aus dem Kundendienstteam wird immer eine ganze Reihe von M&ouml;glichkeiten pr&auml;sentieren im Zusammenhang mit der Umsetzung von Projekts. Wir wissen, dass Informationen heutzutage am wichtigsten sind, deshalb sorgen wir daf&uuml;r, dass unsere Kunden &uuml;ber alle Fragen der Zusammenarbeit so gut wie m&ouml;glich informiert sind. Wir garantieren p&uuml;nktliche Lieferungen, schnelle Entscheidungen und Bereitschaft, auch die schwierigsten Probleme der Produktion und Logistik zu l&ouml;sen. Ein solch professioneller, umfassender und flexibler Service erm&ouml;glicht es uns, dauerhafte Beziehungen zu unseren Kunden aufzubauen.</p>', NULL, '2020-09-09 13:23:44', '2020-09-09 13:23:44'),
(190, 2, 'Obsługa klient', 'im_object', 'content', 107, '<p>Each company has different needs, and that is why at Royalpack, each customer is treated individually. A dedicated person from the Customer Service team will always present a full range of possibilities related to the implementation of a given project. We know that in our times information is the most important thing; therefore, we ensure that our customers are well informed about all matters related to the cooperation. We guarantee timely deliveries, quick decision-making and readiness to solve even most difficult production and logistics problems. Services provided in such a professional, comprehensive and flexible way allows us to build long-lasting relationships with our customers.</p>', NULL, '2020-09-09 13:24:19', '2020-09-09 13:24:19'),
