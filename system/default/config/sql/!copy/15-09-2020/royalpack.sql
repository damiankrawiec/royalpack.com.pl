...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 15 Wrz 2020, 10:46
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `section_id` (`section_id`),
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2062 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=221 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
