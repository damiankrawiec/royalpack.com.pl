...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 08 Paź 2020, 16:40
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `section_id` (`section_id`),
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2222 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
