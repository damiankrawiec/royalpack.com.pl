...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 17 Lis 2020, 16:46
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `section_id` (`section_id`),
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2301 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(127, 2, 'Sustainable development policy', 'im_object', 'name', 84, 'SUSTAINABLE DEVLOPMENT POLICY', NULL, '2020-09-09 08:26:18', '2020-11-10 15:40:56'),
