...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 18 Sie 2020, 15:21
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `section_id` (`section_id`),
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1760 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
