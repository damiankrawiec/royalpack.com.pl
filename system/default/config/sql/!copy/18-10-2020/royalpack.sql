...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 18 Paź 2020, 16:23
...
(25, 4, 'Park maszynowy', '', 'park-maszynowy', '', 'fal fa-angle-right', 'container', '', 3, 'on', 'on', 'off', 'on', 'on', '', '2020-06-21 17:06:56', '2020-10-18 18:19:01'),
(26, 4, 'R&D', '', 'rd', '', 'fal fa-angle-right', 'container', '', 4, 'on', 'on', 'off', 'on', 'on', '', '2020-06-21 17:07:12', '2020-10-18 18:18:29'),
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `section_id` (`section_id`),
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2236 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
