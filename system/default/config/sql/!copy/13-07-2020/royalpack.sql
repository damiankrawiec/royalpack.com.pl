...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 13 Lip 2020, 20:38
...
(17, 'Flagi', 'flags', NULL, NULL, '2020-07-13 21:52:04', '2020-07-13 21:52:04');
...
(24, 7, 17, 0, '', 'Języki', '', '<div class=\"change-language\">\r\n<ul>\r\n<li id=\"pl\"><img src=\"system/default/public/flag/pl.svg\" /></li>\r\n<li id=\"en\"><img src=\"system/default/public/flag/gb.svg\" /></li>\r\n<li id=\"de\"><img src=\"system/default/public/flag/de.svg\" /></li>\r\n</ul>\r\n</div>', '', '', '', '', '', '', 3, 'on', 'off', '', '2020-07-13', '2020-07-13 21:52:21', '2020-07-13 22:24:35');
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `section_id` (`section_id`),
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1018 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(14, 'Nazwa', 'col-12', 'on', '', '2020-07-13 20:57:08', '2020-07-13 20:57:13'),
(15, 'Treść z formularzem', 'col-12', 'on', 'W jednym wierszu', '2020-07-13 21:00:33', '2020-07-13 21:01:53');
