...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 07 Paź 2020, 10:21
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `section_id` (`section_id`),
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2216 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(7, 'Content class', 'class-content', 'class-content', '', '2020-09-15 08:47:13', '2020-10-07 12:17:56'),
(8, 'Loading page', 'loading-page', 'background: #fff;|top:30%;|color:#e0c469;font-size: 150px;|fad fa-spinner-third fa-spin|fadeOutUp|800', 'Background style, icon box style, icon style, icon class, animation, visible time', '2020-10-07 12:02:35', '2020-10-07 12:10:39');
